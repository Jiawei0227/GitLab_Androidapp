...
public class QuestionListAdapter extends BaseAdapter {
    ...
    public QuestionListAdapter(List<PublishTaskItem> indexInfoItems, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        title.setText(courseInfos.get(position).title);

        TextView title2 = (TextView)convertView.findViewById(R.id.index_info_subtitle);
        title2.setText(courseInfos.get(position).state);
